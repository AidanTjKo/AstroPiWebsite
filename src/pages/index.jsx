    ...
    return (
        <>
            ...
            <div style={{backgroundImage:`url(${spaceBanner.src})`}} className="h-screen w-screen bg-contain bg-center bg-repeat content-center relative">
                <Link href="/our-team" className="py-10 -ml-32 -mt-36 left-1/2 top-1/2 text-center relative inline-flex items-center justify-center px-20 overflow-hidden font-mono font-medium tracking-tighter text-white bg-gray-800 rounded-lg group">
