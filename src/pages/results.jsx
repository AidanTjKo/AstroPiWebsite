...
import valuesIntoEquation from 'src/images/photos/valuesIntoEquation.png'
import temp from 'src/images/photos/temp.png'
...
return (
    ...
    <div class="relative overflow-x-auto shadow-md rounded-lg pt-32">
        ...
        <p className="text-3xl tracking-tight text-slate-100 mt-20 text-center sm:text-4xl py-10">
            Our results allowed us to determine that the average velocity of the ISS was:  <span className='font-bold animate-bounce'>  7782.166785m/s</span>
        </p>
    </div>

    <div style={{width:"10wh"}} className="bg-white mb-8 py-10">
        <p className="text-3xl font-bold tracking-tight text-slate-600 mt-20 text-center sm:text-4xl py-10">Plugging our values and constants into Energy Ratio Equation</p>
        <Image
            src={valuesIntoEquation}
            unoptimized={true}
            alt=""
            sizes="(min-width: 1024px) 32rem, 20rem"
            className="px-32 py-20 aspect-auto rounded-2xl md:object-scale-down md:h-96 bg-white"
        />
        <Image
            src={temp}
            unoptimized={true}
            ...
            className="aspect-auto px-32 md:object-cover rounded-2xl bg-white"
        />
    </div>
    {/* <Link href='/timeline'>
        <section
